<?php
    ...
    if(backupGuardIsAjax() && count($_POST)) {
        ...
        $cronTab = '* '.(int)$options['scheduleHour'].' '.backupGuardSanitizeTextField($options['scheduleInterval']).$scheduleIntervalDay;
        ...
        if ($options['backupType'] == SG_BACKUP_TYPE_FULL) {
            ...
            array_push($error, _backupGuardT('Invalid backup type'));
            die(json_encode($error));
        }
