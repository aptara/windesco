...
<div class="carousel-slider-outer carousel-slider-outer-posts carousel-slider-outer-<?php echo $id; ?>">
    ...
    <div <?php echo join( " ", $this->carousel_options( $id ) ); ?>>
		...
		foreach ( $posts as $_post ):
			...
			$html .= sprintf( '<a class="carousel-slider__post-title" href="%s"><h1>%s</h1></a>', $_permalink, '<div class="carousel-slider__post-excerpt">' . $_excerpt . '</div> ' );
			//$html .= ;
			...
			$html .= '<div class="carousel-slider__post-author">' . $_author_name . '</div>';
