...
class ET_Builder_Theme_Compat_The7 {
	...
	function fix_woocommerce_styling() {
		$style = '
			.et_divi_builder #et_builder_outer_content .et_pb_shop .featured { display: block !important; }
			.et_divi_builder #et_builder_outer_content .et_pb_shop .product { padding: 10px; }
			.et_divi_builder #et_builder_outer_content .et_pb_shop .product .woo-buttons-on-img img { display: block; width: 100%; }
			.et_divi_builder #et_builder_outer_content .et_pb_shop .woocommerce.columns-1 .wf-cell  { width: 100%; }
			.et_divi_builder #et_builder_outer_content .et_pb_shop .woocommerce.columns-2 .wf-cell  { width: 49%; }
			.et_divi_builder #et_builder_outer_content .et_pb_shop .woocommerce.columns-3 .wf-cell  { width: 33.33%; }
			.et_divi_builder #et_builder_outer_content .et_pb_shop .woocommerce.columns-4 .wf-cell  { width: 25%; }
			.et_divi_builder #et_builder_outer_content .et_pb_shop .woocommerce.columns-5 .wf-cell  { width: 20%; }
			.et_divi_builder #et_builder_outer_content .et_pb_shop .woocommerce.columns-6 .wf-cell  { width: 16.4%; }
		';
